...
This tutorial is organized as a series of short chapters.
Each chapter focuses on creating a Parsley specification for a specific data format.
Each chapter was designed to be done in a single short sitting (5-30 minutes).
