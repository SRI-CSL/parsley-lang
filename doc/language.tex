...
\begin{figure}
  ...
  \begin{align}
    ...
    \Gamma\Vdash \textrm{case }e\ \{\rho_i, e_i\}\Rightarrow_\utv\omega
      &\typrule \Gamma,\etv\Vdash e\Rightarrow_{\utv'}(\{\rho_i\},\utv')\Rightarrow_{\utv''}\mathrm{cover}(\{\rho_i\},\utv''),\omega' \notag\\
      &\qquad\qquad\text{where }\omega'=(\rho_1,\utv'')\oplus e_1\Rightarrow_{\utv_1}\ldots(\rho_n,\utv'')\oplus e_n\Rightarrow_{\utv_n}\omega'' \notag\\
      &\qquad\qquad\text{and }\omega''=\utv_1\leq\etv,\ldots,\utv_{n-1}\leq\etv, [\etv/\utv]\omega
  \end{align}
