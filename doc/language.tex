...
\begin{figure}
  ...
  $$ \prftree{\prfassumption{\etv\notin FV(\sigma_1)\cup FV(\sigma_2)}}
             ...
             {\Gamma[\etv]\vdash\sigma_1\rightarrow\sigma_2\leq\etv;\Omega} $$
  $$ \prftree{\prfassumption{\etv\notin\cup_iFV(\sigma_i)}}
             {\prfassumption{\Gamma[[\etv_i]]\vdash[\etv_i\leq\sigma_i];[(\etv_i)/\etv]\Omega}}
             {\Gamma[\etv]\vdash\etv\leq(\sigma_i);\Omega} $$
  $$ \prftree{\prfassumption{\etv\notin\cup_iFV(\sigma_i)}}
             {\prfassumption{\Gamma[[\etv_i]]\vdash[\sigma_i\leq\etv_i];[(\etv_i)/\etv]\Omega}}
             {\Gamma[\etv]\vdash(\sigma_i)\leq\etv;\Omega} $$
  $$ \prftree{\prfassumption{\etv\notin\cup_iFV(\sigma_i)}}
             {\prfassumption{\Gamma[[\etv_i]]\vdash[\etv_i\leq\sigma_i];[\{l_i:\etv_i\}/\etv]\Omega}}
             {\Gamma[\etv]\vdash\etv\leq\{l_i:\sigma_i\};\Omega} $$
  $$ \prftree{\prfassumption{\etv\notin\cup_iFV(\sigma_i)}}
             {\prfassumption{\Gamma[[\etv_i]]\vdash[\sigma_i\leq\etv_i];[\{l_i:\etv_i\}/\etv]\Omega}}
             {\Gamma[\etv]\vdash\{l_i:\sigma_i\}\leq\etv;\Omega} $$
  $$ \prftree{\prfassumption{\etv\notin\cup_iFV(\sigma_i)}}
             {\prfassumption{\Gamma[[\etv_i]]\vdash[\etv_i\leq\sigma_i];[\sum_iC_i\etv_i/\etv]\Omega}}
             {\Gamma[\etv]\vdash\etv\leq\sum_iC_i\sigma_i;\Omega} $$
  $$ \prftree{\prfassumption{\etv\notin\cup_iFV(\sigma_i)}}
             {\prfassumption{\Gamma[[\etv_i]]\vdash[\sigma_i\leq\etv_i];[\sum_iC_i\etv_i\}/\etv]\Omega}}
             {\Gamma[\etv]\vdash\sum_iC_i\sigma_i\leq\etv;\Omega} $$
...
\begin{figure}
  $$ \boxed{\Gamma\vdash\Omega} $$
  $$ $$
  $$ \prftree{\prfassumption{\Gamma[\etv_1][]\vdash[\etv_1/\etv_2]\Omega}}
             {\Gamma[\etv_1][\etv_2]\vdash\etv_1\leq\etv_2;\Omega}\qquad
     \prftree{\prfassumption{\Gamma[\etv_1][]\vdash[\etv_1/\etv_2]\Omega}}
             {\Gamma[\etv_1][\etv_2]\vdash\etv_2\leq\etv_1;\Omega} $$
  $$ \prftree{\prfassumption{\Gamma[\utv][]\vdash[\utv/\etv]\Omega}}
             {\Gamma[\utv][\etv]\vdash\utv\leq\etv;\Omega}\qquad
     \prftree{\prfassumption{\Gamma[\utv][]\vdash[\utv/\etv]\Omega}}
             {\Gamma[\utv][\etv]\vdash\etv\leq\utv;\Omega} $$
  $$ \prftree{\prfassumption{\Gamma[]\vdash[\nu/\etv]\Omega}}
             {\Gamma[\etv]\vdash\nu\leq\etv;\Omega}\qquad
     \prftree{\prfassumption{\Gamma[]\vdash[\nu/\etv]\Omega}}
