...
\begin{figure}
  \begin{tabular}{l c l l l}
    ...
    Judgment chain        & $\omega$ & ::= & $ \iota $                         & single judgment \\
                          ...
                          &          &     & $ e\Rightarrow_\utv\omega $       & type inference \\
                          &          &     & $ \sigma\bullet e\rightsquigarrow_\utv\omega $  & application inference \\
                          &          &     & $ (\{\rho_i\},\tau)\Rightarrow_\utv\omega $     & pattern type refinement \\
                          &          &     & $ (\rho,\tau)\oplus e\Rightarrow_\utv\omega $   & patterned type inference \\
                          &          &     &                                   & \\
...
\begin{figure}
  ...
  \begin{gather*}
    \begin{aligned}
      ...
      \Gamma\Vdash \textrm{case }e\ \{\rho_i, e_i\}\Rightarrow_\utv\omega
        &\typrule \Gamma\Vdash e\Rightarrow_{\utv'}(\{\rho_i\},\utv')\Rightarrow_{\utv''}\mathrm{cover}(\{\rho_i\},\utv''),\omega' \\
        &\qquad\qquad\text{where }\omega'=(\rho_1,\utv'')\oplus e_1\Rightarrow_{\utv_1}\ldots(\rho_n,\utv'')\oplus e_n\Rightarrow_{\utv_n}\omega'' \\
        &\qquad\qquad\text{and }\omega''=\utv_1\leq\utv_2,\ldots,\utv_{n-1}\leq\utv_n,\utv_n\leq\utv\Rightarrow_\utv\omega
    \end{aligned}
  \end{gather*}
