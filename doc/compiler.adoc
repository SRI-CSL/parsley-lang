...
The intepreter prints the value of each successfully parsed instance
on the standard output, and stops at the first parse error.
...
expressions in the specification.  The `$print`
<<grammar.adoc#printing,statement>> was added to the language for this
purpose.
