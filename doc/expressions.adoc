...
constant natural numbers as arguments instead of other types.  A
...
*Bitfields* are specialized records that allowing naming of contiguous
...
bitvectors of type `(bitvector<2>, bitvector<`>)`.
