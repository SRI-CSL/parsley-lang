...
Values of type `view` are opaque, and they cannot be meaningfully
compared for equality and inequality using the generic `=` and `!=`
operators.  Both operators will return false for view arguments.
